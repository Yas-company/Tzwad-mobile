...
class ConstantColors {
  // static const Color primaryColor = Color(0xff00B106);
  static const Color greyThree = Color(0xff818181);
  ...
  static const Color orangeRating = Color(0xffF8B400);
  // static const Color lightPrimery = Color(0xffE3FFE5);
  // static const Color lightPrimery2 = Color(0xffBAEDBF);
  // static const Color lightPrimery3 = Color(0xffDDEFDE);
  static const Color pureGrey = Colors.grey;
  // static const Color pureWhite = Color(0xffFFFFFF);
  // static const Color titleTexts = Color(0xff333333);
