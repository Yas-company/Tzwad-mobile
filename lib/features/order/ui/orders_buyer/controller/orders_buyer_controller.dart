...
import 'orders_buyer_state.dart';

class OrdersBuyerController extends AutoDisposeNotifier<OrdersBuyerState> {
  @override
  OrdersBuyerState build() {
    state = _onInit();
    getOrders();
    return state;
  }

  OrdersBuyerState _onInit() => OrdersBuyerState();
