...
import 'package:tzwad_mobile/features/auth/ui/change_password/hooks/change_password_re_password_hook.dart';
import 'package:tzwad_mobile/features/auth/ui/change_password/providers/change_password_controller_provider.dart';

class ChangePasswordRePasswordWidget extends HookConsumerWidget {
  const ChangePasswordRePasswordWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final errorText = ref.watch(
      changePasswordControllerProvider.select(
        (value) => value.reNewPasswordValidationMessage,
      ),
    );
    ...
    final controller = useChangePasswordRePasswordController(
      ref: ref,
      initialText: '',
    );
    return Column(
      ...
      children: [
        ...
        AppTextFieldWidget(
          ...
          suffixIcon: AppRippleWidget(
            radius: AppSize.s12,
            onTap: () {
              ref.read(changePasswordControllerProvider.notifier).changeVisibilityRePassword();
            },
            child: Icon(
