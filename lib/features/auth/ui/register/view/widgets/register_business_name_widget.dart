...
import 'package:tzwad_mobile/features/auth/ui/register/hooks/register_business_name_hook.dart';
...
class RegisterBusinessNameWidget extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final phoneNumberController = useRegisterBusinessNameController(
      ref: ref,
      initialText: '',
    );
    return Column(
      ...
      children: [
        ...
        AppTextFieldWidget(
          ...
          hintText: 'Write your business name',
