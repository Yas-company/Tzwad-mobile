...
import 'package:tzwad_mobile/features/auth/ui/register_buyer/hooks/register_buyer_name_hook.dart';
...
class RegisterNameWidget extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final phoneNumberController = useRegisterBuyerNameController(
      ref: ref,
      initialText: '',
    );
    return Column(
