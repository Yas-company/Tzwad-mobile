...
import 'form_register_buyer_section.dart';

class RegisterBuyerViewBody extends StatelessWidget {
  const RegisterBuyerViewBody({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const FormRegisterBuyerSection().marginOnly(
              bottom: AppPadding.p16,
            ),
            Align(
