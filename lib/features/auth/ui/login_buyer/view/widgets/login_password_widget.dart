...
import 'package:tzwad_mobile/features/auth/ui/login_buyer/hooks/login_buyer_password_hook.dart';
...
class LoginPasswordWidget extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final passwordController = useLoginBuyerPasswordController(
      ref: ref,
      initialText: '',
    );
      ...
      children: [
        ...
        AppTextFieldWidget(
          ...
          suffixIcon: AppRippleWidget(
            radius: AppSize.s12,
            onTap: () {
              ref.read(loginBuyerControllerProvider.notifier).changeVisibilityPassword();
            },
            child: Icon(
