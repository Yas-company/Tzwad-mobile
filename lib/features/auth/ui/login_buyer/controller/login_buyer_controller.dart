...
import 'login_buyer_state.dart';

class LoginBuyerController extends AutoDisposeNotifier<LoginBuyerState> {
  @override
  LoginBuyerState build() {
    state = _onInit();
    return state;
  }

  LoginBuyerState _onInit() => LoginBuyerState();
