...
import 'form_login_supplier_section.dart';


class LoginSupplierViewBody extends StatelessWidget {
  const LoginSupplierViewBody({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const FormLoginSupplierSection().marginOnly(
              bottom: AppPadding.p16,
            ),
            Row(
  ...
  _onPressedRegisterButton(BuildContext context) {
    context.pushNamed(AppRoutes.registerSupplierRoute);
  }
}
