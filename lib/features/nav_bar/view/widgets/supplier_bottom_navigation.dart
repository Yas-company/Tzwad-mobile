...
class SupplierBottomNavigation extends ConsumerWidget {
  const SupplierBottomNavigation({super.key});
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              ItemBottomNavigation(
                title: 'الاصناف',
                assetName: AssetsManager.icTabProducts,
              ...
              ItemBottomNavigation(
                ...
                onTap: () => _onPressedItemBottomNavigation(ref, context, 4),
  ...
  _onPressedItemBottomNavigation(WidgetRef ref, BuildContext context, int index) {
    ...
    switch (index) {
      case 0:
        context.goNamed(AppRoutes.homeSupplierRoute);
      case 1:
        context.goNamed(AppRoutes.ordersSupplier);
      case 2:
        context.goNamed(AppRoutes.categoriesSupplierRoute);
      case 3:
        context.goNamed(AppRoutes.productsSupplierRoute);
      case 4:
        context.goNamed(AppRoutes.moreSupplierRoute);
